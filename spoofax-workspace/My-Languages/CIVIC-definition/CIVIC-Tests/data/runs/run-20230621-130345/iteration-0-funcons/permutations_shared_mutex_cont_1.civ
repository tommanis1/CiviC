...
try { std::cout << "count:4,function:3,result:" << f2() <<std::endl; } catch (...) { std::cout << "count:4,function:3,result:" << "fail" <<std::endl;};
try { std::cout << "count:5,function:3,result:" << f2() <<std::endl; } catch (...) { std::cout << "count:5,function:3,result:" << "fail" <<std::endl;};
try { std::cout << "count:6,function:4,result:" << f3() <<std::endl; } catch (...) { std::cout << "count:6,function:4,result:" << "fail" <<std::endl;};
try { std::cout << "count:7,function:4,result:" << f3() <<std::endl; } catch (...) { std::cout << "count:7,function:4,result:" << "fail" <<std::endl;};
try { std::cout << "count:8,function:1,result:" << f0() <<std::endl; } catch (...) { std::cout << "count:8,function:1,result:" << "fail" <<std::endl;};
try { std::cout << "count:9,function:1,result:" << f0() <<std::endl; } catch (...) { std::cout << "count:9,function:1,result:" << "fail" <<std::endl;};
try { std::cout << "count:10,function:2,result:" << f1() <<std::endl; } catch (...) { std::cout << "count:10,function:2,result:" << "fail" <<std::endl;};
try { std::cout << "count:11,function:2,result:" << f1() <<std::endl; } catch (...) { std::cout << "count:11,function:2,result:" << "fail" <<std::endl;};
try { std::cout << "count:12,function:3,result:" << f2() <<std::endl; } catch (...) { std::cout << "count:12,function:3,result:" << "fail" <<std::endl;};
try { std::cout << "count:13,function:3,result:" << f2() <<std::endl; } catch (...) { std::cout << "count:13,function:3,result:" << "fail" <<std::endl;};
try { std::cout << "count:14,function:1,result:" << f0() <<std::endl; } catch (...) { std::cout << "count:14,function:1,result:" << "fail" <<std::endl;};
